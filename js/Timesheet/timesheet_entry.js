	...
	if (data["date"] == "" || data["date"] == null) {
		...
		if (time1 == time2) {
			...
			if (ask == true) {
				...
				data["Hr1"] = document.getElementById('job_1H').value + ':'
						+ document.getElementById('job_1M').value + ':00';
				data["Hr2"] = document.getElementById('job_2H').value + ':'
						+ document.getElementById('job_2M').value + ':00';
				data["Hr3"] = document.getElementById('job_3H').value + ':'
						+ document.getElementById('job_3M').value + ':00';
				data["Hr4"] = document.getElementById('job_4H').value + ':'
						+ document.getElementById('job_4M').value + ':00';
				data["Hr5"] = document.getElementById('job_5H').value + ':'
						+ document.getElementById('job_5M').value + ':00';
				data["Hr6"] = document.getElementById('job_6H').value + ':'
						+ document.getElementById('job_6M').value + ':00';
				data["Hr7"] = document.getElementById('job_7H').value + ':'
						+ document.getElementById('job_7M').value + ':00';
				...
				$
						.post(
								site_url
										+ "/Timesheet/timesheet_entry/insert_timesheet_data/",
...
function checkDate(date) {
	...
	$
			.post(
					site_url + "/Timesheet/timesheet_entry/checkDate/",
					{
						d1 : date
					},
					function(data) {
...
function checkLeave(date) {
	$
			.post(
					site_url + "/Timesheet/timesheet_entry/checkLeave/",
					{
						d1 : date
					},
					function(data) {
...
function checkLocked(date) {
	$
			.post(
					site_url + "/Timesheet/timesheet_entry/checkLocked/",
					{
						d1 : date
					},
					function(data) {
...
function get_INOUT(date) {
	...
	$
			.post(
					site_url + "/Timesheet/timesheet_entry/get_INOUT/",
					{
						d1 : date
					},
					function(data) {
...
function process_npjobs(val, no) {
	...
	$.post(site_url + "/Timesheet/timesheet/process_npjobs/", {
		value : val,
		num : no
	}, function(result) {
		window.location.reload();
...
function process_jobs(val, no) {
	...
	$.post(site_url + "/Timesheet/timesheet/process_jobs/", {
		value : val,
		num : no
	}, function(result) {
		window.location.reload();
...
function add_job(type1) {
	...
	if (job_no != "" && desc1 != "") {
		$.post(site_url + "/Timesheet/timesheet/add_jobs/", {
			num : job_no,
			desc : desc1,
			type : type1
		}, function(result) {
...
function update_job(type1) {
	...
	if (job_no != "" && desc1 != "") {
		$.post(site_url + "/Timesheet/timesheet/update_jobs/", {
			num : job_no,
			desc : desc1,
			type : type1,
			id : id1
...
function get_timesheet_overall() {
	...
	$.post(site_url + "/Timesheet/timesheet/get_timesheet_overall", {
		d1 : date1,
		d2 : date2
	}, function(data) {
		$("#contentData").html("");
...
function get_timesheet_jobwise() {
	...
	document.getElementById('getuser2').style.display = "none";
	document.getElementById('getuser2').value = "";
	document.getElementById('report_option').value = "Time Sheet Report for JOB No: "
			+ num1;

	if (num1 != "") {

		$.post(site_url + "/Timesheet/timesheet/get_timesheet_jobwise", {
			d1 : date1,
			d2 : date2,
			num : num1
		}, function(data) {
...
function get_timesheet_userwise() {
	...
	document.getElementById('getuser2').style.display = "none";
	document.getElementById('getuser2').value = "";
	document.getElementById('report_option').value = "Time Sheet Report of "
			+ user1;

	if (user1 != "") {

		$.post(site_url + "/Timesheet/timesheet/get_timesheet_userwise", {
			d1 : date1,
			d2 : date2,
			user : user1
		}, function(data) {
...
function get_timesheet_ot() {
	...
	if (date1 != "" && date2 != "") {
		...
		$.post(site_url + "/Timesheet/timesheet/get_timesheet_ot", {
			d1 : date1,
			d2 : date2
		}, function(data) {
			$("#contentData").html("");
...
function timesheet_activity_emp() {
	...
	document.getElementById('getuser2').style.display = "none";
	document.getElementById('getuser2').value = "";
	document.getElementById('report_option').value = "Time Activities Report of "
			+ user1;

	if (user1 != "") {

		$.post(site_url + "/Timesheet/timesheet/timesheet_activity_emp", {
			d1 : date1,
			d2 : date2,
			user : user1
		}, function(data) {
...
function user_timesheet_overall() {
	...
	document.getElementById('report_option').value = "Over all Jobwise Report of "
			+ uname;
	document.getElementById('getjob').style.display = "none";
	document.getElementById('getjob').value = "";

	$.post(site_url + "/Timesheet/timesheet/user_timesheet_overall", {
		d1 : date1,
		d2 : date2
	}, function(data) {
		$("#contentData").html("");
...
function user_timesheet_jobwise() {
	...
	if (num1 != "") {
		...
		$.post(site_url + "/Timesheet/timesheet/user_timesheet_jobwise", {
			d1 : date1,
			d2 : date2,
			num : num1
		}, function(data) {
...
function timesheet_activity_user() {
	...
	$.post(site_url + "/Timesheet/timesheet/timesheet_activity_user", {
		d1 : date1,
		d2 : date2
	}, function(data) {
		$("#contentData").html("");
...
function team_timesheet_overall() {
	...
	$.post(site_url + "/Timesheet/timesheet/team_timesheet_overall", {
		d1 : date1,
		d2 : date2
	}, function(data) {
		$("#contentData").html("");
...
function team_timesheet_jobwise() {
	...
	if (num1 != "") {
		...
		$.post(site_url + "/Timesheet/timesheet/team_timesheet_jobwise", {
			d1 : date1,
			d2 : date2,
			num : num1
		}, function(data) {
...
function team_timesheet_ot() {
	...
	document.getElementById('getuser1').value = "";
	var uname = document.getElementById('emp_name').value;
	document.getElementById('report_option').value = "Total Working Hours Details of "
			+ uname;

	// if( date1 != "" && date2!="" ){
	$.post(site_url + "/Timesheet/timesheet/team_timesheet_ot", {
		d1 : date1,
		d2 : date2
	}, function(data) {
		$("#contentData").html("");
...
function get_timedate(date1) {
	...
	$.post(site_url + "/Timesheet/timesheet/get_timedate", {
		date : date1
	}, function(data) {
		$("#contentData").html("");
		$("#contentData").append(data);
...
function update_changes() {
	...
	if (document.getElementById('intime').value != ''
		...
		if (ask == true) {
			...
			$.post(site_url + "/Timesheet/timesheet/update_changes", data,
					function(datas) {
						alert(datas);
						get_timedate(date);
					});
...
function get_timesheet_Dept() {
	...
	document.getElementById('report_option').value = "Time Sheet Activities Report of "
			+ dept1 + " Department";

	if (dept1 != "") {

		$.post(site_url + "/Timesheet/timesheet/get_timesheet_Dept", {
			d1 : date1,
			d2 : date2,
			dept : dept1
		}, function(data) {
...
function get_timesheet_Team() {
	...
	if (job1 == "") {
		...
		if (team1 != "") {
			...
			$.post(site_url + "/Timesheet/timesheet/get_timesheet_Team/", {
				d1 : date1,
				d2 : date2,
				team : team1
			}, function(data) {
...
function timesheet_team_job() {
	...
	document.getElementById('getDept').value = "";
	document.getElementById('report_option').value = "Time Sheet Activities Report of "
			+ team1 + " Team for JOB No: " + job1;

	if (job1 != "") {

		$.post(site_url + "/Timesheet/timesheet/timesheet_team_job", {
			d1 : date1,
			d2 : date2,
			job : job1,
			team : team1
...
function get_UpdatedUsers(date1) {
	...
	if (date1 != "") {
		$.post(site_url + "/Timesheet/timesheet/get_timeofficeID/", {
			date : date1
		}, function(data) {
			// alert(data);
			$("#contentData").html("");
...
function update_timeoffice() {
	...
	// alert(rows);
	var date = document.getElementById('date').value;
	var key = confirm("Do you want to update IN-OUT time of Employees for the Date - "
			+ date);
	if (key == true) {
		for (i = 1; i <= rows; i++) {
			...
			var intime = document.getElementById(inH).value + ':'
					+ document.getElementById(inM).value;
			var outtime = document.getElementById(outH).value + ':'
					+ document.getElementById(outM).value;
			// alert(id+':'+intime+':'+outtime);
			if (intime != "00:00" && outtime != '00:00' && date != ""
					&& date1 != "") {
				$.post(site_url + "/Timesheet/timesheet/update_timeoffice/", {
					id1 : id,
					d1 : date,
					d2 : date1,
					in1 : intime,
...
function timesheet_job_activity_user() {
	...
	var date2 = document.getElementById('date_to').value;
	var uname = document.getElementById('emp_name').value;
	document.getElementById('report_option').value = "Job Activities Report of "
			+ uname;
	document.getElementById('getjob').style.display = "";
	document.getElementById('getjob').style.display = "none";
	document.getElementById('getjob').value = "";

	$.post(site_url + "/Timesheet/timesheet/timesheet_job_activity_user", {
		d1 : date1,
		d2 : date2
	}, function(data) {
		$("#contentData").html("");
...
function timesheet_job_activity_emp() {
	...
	if (user2 != "") {
		...
		$.post(site_url + "/Timesheet/timesheet/timesheet_job_activity_emp", {
			d1 : date1,
			d2 : date2,
			user : user2
		}, function(data) {
...
function check_job(job1) {
	...
	if (job1 != "") {
		$
				.post(
						site_url + "/Timesheet/timesheet/check_job",
						{
							job : job1
						},
						function(data1) {
							...
							if (data1 != "") {
								...
								document.getElementById("job_desc")
										.setAttribute("readonly", 1);
							} else {
								$
										.post(
												site_url
														+ "/Timesheet/timesheet/fetch_job",
												{
													job : job1
												},
												function(data) {
													document
															.getElementById('job_no').value = job1;
													document
															.getElementById('job_desc').value = data;
...
function check_npjob(job1) {
	...
	if (job1 != "") {
		$.post(site_url + "/Timesheet/timesheet/check_npjob", {
			job : job1
		}, function(data1) {
			// alert(data);
			if (data1 != "") {
				...
				document.getElementById("npjob_desc").setAttribute("readonly",
						1);
			} else {
				$.post(site_url + "/Timesheet/timesheet/fetch_npjob", {
					job : job1
				}, function(data) {
					document.getElementById('npjob_no').value = job1;
					document.getElementById('npjob_desc').value = data;
					document.getElementById("npjob_no").removeAttribute(
							"readonly", 1);
					document.getElementById("npjob_desc").removeAttribute(
							"readonly", 1);
...
function get_locked_users(op) {
	if (op == '1') {
		...
		if (yr != "" && emp1 != "") {
			$.post(site_url + "/Timesheet/timesheet/get_locked_users", {
				year : yr,
				month : mon
			}, function(data) {
				$("#contentData").html("");
	...
	if (op == '2') {
		...
		var mon = document.getElementById('month').value;
		if (yr != "" && emp1 != "") {
			$.post(site_url + "/Timesheet/timesheet/get_locked_user", {
				year : yr,
				month : mon,
				emp : emp1
			}, function(data) {
...
function unlock_timesheet(id1) {
	...
	$.post(site_url + "/Timesheet/timesheet/unlock_timesheet", {
		id : id1
	}, function(data) {
