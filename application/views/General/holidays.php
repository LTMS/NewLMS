...
<div align="center"
	style="float: left; height: auto; background: #59955C; margin: 10px 0px 0px 130px; width: 75%; border: 2px solid black; border-radius: 5px;">
	...
	<table border="1" width="100%" style="border-right: 1px solid white;"
		...
		<tr align="center" bgcolor="DBEADC"
			...
			<td align="center">Date: <input type="text" id="date1"
				style="width: 80px; color: blue; font-weight: bold" />&nbsp;&nbsp;&nbsp;&nbsp;
				Description: <input type="text" id="desc1"
				style="width: 250px; color: blue" /> &nbsp;&nbsp;&nbsp;&nbsp;
				<button style="color: green; font-weight: bolder"
					onclick="add_holiday()">Add Holiday</button></td>
		</tr>


		<tr style="background: #DBEADC;">
			<td align="center" colspan="5">YEAR : <select id="year"
				onclick="show_holidays(this.value)"
		...
		<table>
			<tr bgcolor="#518C9C" style="border-right: 1px solid white;">
				...
				<td align="center" style="border-right: 1px solid white;"><font
					...
					<?php  if($this->session->userdata('userrole')=='MD' || $this->session->userdata('userrole')=='admin'){
						print('<td align="center"  style="border-right:1px solid white;"><font color="white">Remove</font></td>');
					}?>
			</tr>
			<tr>
			...
			foreach($holidays as $row) {
				...
				if($this->session->userdata('userrole')=='MD' || $this->session->userdata('userrole')=='admin'){
