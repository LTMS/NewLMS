...
print("<td width='4%' align='center'>LeaveID</td>");
...
foreach($result as $openrow) {
	...
	print("<td width='4%' align='center'><input type='button'  style='width:100px' onclick='select_row(\"$counter\",\"$type\",\"$day\",\"$d1\",\"$d2\",\"$user\",this.value,\"$status\",\"$reason\",\"$apptime\",\"$appby\")' value='".$openrow["LeaveID"]."'> </td>");
	...
	if($openrow["Description"]=='L1 - Approved' || $openrow["Description"]=='L2 - Approved'){
		print("<td width='10%' align='center' style='color:green'>".$status."</td>");
	}
	else if($openrow["Description"]=='Leave Applied'){
...
print("<tr height='20%' style='background:grey;font-size:19px;font-weight:bold;color:white;border-color:black'>");
...
print('<tr id="buttonrow"><td  align="right" colspan="2"><input type="button" style="width:100px;height:30px;font-size:15pt;color:white;background-color:green; font-family:Tahoma"onclick="approve()" value="Approve"/></td> &nbsp;&nbsp;&nbsp;');
...
//	print('<tr><td  align="right" colspan="2"><input type="button" style="width:100px;height:30px;font-size:15pt;color:white;background-color:green; font-family:Tahoma"onclick="approve()" value="Approve"/></td> &nbsp;&nbsp;&nbsp;');
//	print('<td align="left" colspan="2"><img src="../../images/tickmark1.png" onmouseover="" onmouseout="" style="width:100px;height:30px;font-size:15pt;color:white; background-color:red;font-family:Tahoma"onclick="reject()"value="Reject"/></td></tr>');

//  print("<div id='leavesDiv' style='display:none' >");
	
//	 print("<tr style='background:grey;font-size:14px;font-weight:bold;color:white;border-color:black'>");
//			      print("<td width='110' align='left' colspan='4'>List of Employees taken Leave on this Day</td></tr>");
