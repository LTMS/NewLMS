...
<?php
		...
		foreach($result as $openrow) {
			...
			print("<img  valign='bottom' id='$app_img' style='width:50px;height:21px;' src='../../../images/Leave/approve.png' onmouseover='change_OnMouseOver(\"$app_img\",\"pass_over.png\")' onmouseout='change_OnMouseOver(\"$app_img\",\"pass.png\")'  onclick='update_LeaveStatusReporter(\"$leave_id\",2,\"$button_row\",\"$emp_name\",\"$emp_num\",\"$type\",\"$d1\",\"$tot_days\",\"$reason\",\"$apptime\")'/> &nbsp;&nbsp;");
			print("<img  valign='bottom' id='$rej_img'   style='width:50px;height:21px;'src='../../../images/Leave/reject.png'       onmouseover='change_OnMouseOver(\"$rej_img\",\"reject_over.png\")'        onmouseout='change_OnMouseOver(\"$rej_img\",\"reject.png\")'         onclick='update_LeaveStatusReporter(\"$leave_id\",3,\"$button_row\",\"$emp_name\",\"$emp_num\",\"$type\",\"$d1\",\"$tot_days\",\"$reason\",\"$apptime\")'/>");
			print("</td></tr>");
		}
		print("</table>");
