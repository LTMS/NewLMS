...
print("<table  border='1' align='left' cellpadding='1' cellspacing='1'   style='border-collapse:collapse;'>");
// print("<tr style='color:red;font-size:12px;font-weight:bolder; '><td colspan='8' align='center'>The Result shows 'Total Working Hours' spent by an Employee for Every Job  between the selected Date</td></tr>");
...
print("<td width='50%' align='center'>Job Description</td>");
...
foreach($history as $openrow) {
	...
	print("<td width='50%' align='center'>".$openrow["num"]." - ".$openrow["desc"]."</td>");
	print("<td width='10%' align='center'>".$openrow["total"]."</td>");
	print("<td width='10%' align='center'>".$openrow["avg"]."</td>");
